...
###############################################################
### (c) 2015 by G. Carlier, V. Chernozhukov, A. Galichon ######
################ www.alfredgalichon.com/vqr ###################
###############################################################
###############################################################
# Reference:
# G. Carlier, V. Chernozhukov, A. Galichon (2015)
# "Vector Quantile Regression". Arxiv:1406.4643. 
# forthcoming in the Annals of Statistics
#
# Original code in Matlab by A. Galichon
# Translated into R by Jerome Santoul
#
###############################################################
###############################################################
#
...
load_VQRData<-function(folderName){
  VQRDataPath  <- paste0(getwd(),"/VQR/Data/",folderName)
